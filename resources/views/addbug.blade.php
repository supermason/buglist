...
<div class="container">
    ...
    <div class="panel panel-primary" >
        <div class="panel-heading fix-right-btn">
            添加Bug信息 <a class="btn btn-default btn-sm top-right" href="javascript:history.go(-1);"><span class="glyphicon glyphicon-backward"></span>&nbsp;返回</a>
        </div>
            ...
            <fieldset>
                <form class="form-horizontal" id="addForm" method="POST" action="{{ URL('/store')}}" onsubmit="return fillFormData(this);" >
                    ...
                    <div class="form-group">
                        ...
                        <input id="bugDetail" name="bugDetail" type="hidden" required/>
                        <div class=" col-sm-11">
